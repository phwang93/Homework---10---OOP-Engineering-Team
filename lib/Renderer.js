...
const templates = path.resolve(__dirname, "../htmlTemplates");
...
const renderOutput = html => {
    const template = fs.readFileSync(path.resolve(templates, "output.html"), "utf8");
